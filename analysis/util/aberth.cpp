...
static void aberthIterate(const std::vector<double>& P, std::vector<std::complex<double>>& roots)
{
    int iteration = 0;
...
std::vector<std::complex<double>> Analysis::aberthRoots(
...
std::vector<Point> kMeansClustering(std::vector<Point>& points, int epochs, int k)
{
    ...
    std::vector<double> sumX(k);
    std::vector<double> sumY(k);
...
std::vector<std::complex<double>> Analysis::aberthRootsAroundInitial(
        const std::vector<double>& P, double r, double phi, int count)
{
    ...
    std::vector<Point> points(degree);
    for (int i = 0; i < degree; ++i) {
    ...
    std::vector<std::complex<double>> pickedRoots;
